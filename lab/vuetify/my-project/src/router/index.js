...
// ContainerGrid
const ContainerGrid = resolve => require(['comp/container/ContainerSheets'], resolve)

// ContainerOriginal
const ContainerOriginal = resolve => require(['comp/container/ContainerSheets'], resolve)
